...
class Juego {
  ...
  inicializar() {
    ...
    this.elegirColor =
      this.elegirColor.bind(
        this
      ); /* Asi lo podemos poner directamente para ahorrarnos 'amarrar' este metodo en el event listener */
  ...
  iluminarSecuencia() {
    for (let i = 0; i < this.nivel; i++) {
      const color = this.transformarNumeroAColor(
        this.secuencia[i]
      ); /* Es crucial que sea const en vez de var para que funcione en un ciclo for*/
